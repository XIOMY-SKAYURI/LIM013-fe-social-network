...
<input type="text" class='register' placeholder="  nombres" id="name" >
  ...
  <input type="password" class='register' id="password"   placeholder="  contraseña">
   ...
   <p4 class='p4'>Al crear una cuenta en Research Easy, acepta cumplir con nuestros términos, condiciones de servicio y código de honor y acepta nuestras políticas.</p4>
   </div>
